    ...
    return (
        <div className="bg-gray-100 min-h-screen py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-8">
                ...
                <h3 className="text-lg md:text-xl lg:text-2xl text-gray-600 font-semibold mt-6 mb-2">What is a Kidney Stone?</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                <h3 className="text-lg md:text-xl lg:text-2xl text-gray-600 font-semibold mt-6 mb-2">Signs and Symptoms of a Kidney Stone</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                <h3 className="text-lg md:text-xl lg:text-2xl text-gray-600 font-semibold mt-6 mb-2">Not All Kidney Stones Need Treatment</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                <h3 className="text-lg md:text-xl lg:text-2xl text-gray-600 font-semibold mt-6 mb-2">When You Should See a Kidney Doctor in Conroe, The Woodlands, and Houston, TX</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
