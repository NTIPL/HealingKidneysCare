    ...
    return (
        <div className="bg-gray-100 min-h-screen py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-8">
                {/* Header */}
                <h2 className="text-3xl font-bold text-gray-800 mb-6">Kidney Stones</h2>
                ...
                <h3 className="text-2xl text-gray-700 font-semibold mt-6 mb-2">What is a Kidney Stone?</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                <h3 className="text-2xl text-gray-700 font-semibold mt-6 mb-2">Signs and Symptoms of a Kidney Stone</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                <h3 className="text-2xl text-gray-700 font-semibold mt-6 mb-2">Not All Kidney Stones Need Treatment</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                <h3 className="text-2xl text-gray-700 font-semibold mt-6 mb-2">When You Should See a Kidney Doctor in Conroe, The Woodlands, and Houston, TX</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                <h3 className="text-2xl text-gray-700 font-semibold mt-6 mb-2">Treatment of Kidney Stones</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                {/* The ESWL Procedure */}
                <h3 className="text-2xl text-gray-700 font-semibold mt-6 mb-2">The ESWL Procedure</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                {/* Contact Section */}
                <h3 className="text-2xl text-gray-700 font-semibold mt-6 mb-2">Want To Know More?</h3>
                <p className="text-gray-700 leading-relaxed mb-8">
                ...
                You can reach them in any of their three convenient office locations in Conroe, The Woodlands, and Houston, TX, by calling <a href="tel:8326102822" className="text-blue-500 hover:text-blue-800 font-bold">(832) 610-2822</a>, so call today.
                </p>
            </div>
        </div>
    );
