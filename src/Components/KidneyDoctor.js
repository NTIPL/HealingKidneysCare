        ...
        <div className="min-h-screen py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto border rounded-lg p-8">
                ...
                <p className="text-black text-center font-bold leading-relaxed mb-8">
                    ...
                    You can reach our Houston, Conroe, or The Woodlands, TX office today at  <a href="tel:8326102822" className="text-link-orange no-underline hover:text-blue-800 hover:underline font-bold">(832) 610-2822</a>!
                </p>
            </div>
        </div>
    );
