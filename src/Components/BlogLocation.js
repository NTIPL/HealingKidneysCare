                        ...
                        <div className="space-y-1 h-full overflow-auto"> {/* Allow scrolling if necessary */}
                            {hours.map((item) => (
                                <div key={item.day} className="flex w-full">
                                    <div className="bg-[#c64f22] text-white text-sm p-2 font-semibold text-center w-1/2"> {/* Set a fixed width for day labels */}
                                        {item.day}:
                                    </div>
                                    <div className="p-2 bg-[#f3f3f3] text-center text-sm flex-1"> {/* Allow hours to take remaining space */}
                                        {item.hours}
                                    </div>
                                </div>
                            ))}
