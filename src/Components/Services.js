                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="list-disc pl-5">
                            <li><a href="#acute-kidney-injury" className="font-bold text-blue-500 no-underline hover:text-blue-800">Acute Kidney Injury</a></li>
                            <li><a href="#chronic-kidney-disease" className="font-bold text-blue-500 no-underline hover:text-blue-800">Chronic Kidney Disease (CKD)</a></li>
                            <li><a href="#esrd-dialysis" className="font-bold text-blue-500 no-underline hover:text-blue-800">End Stage Renal Disease/Dialysis</a></li>
                            <li><a href="#kidney-stones" className="font-bold text-blue-500 no-underline hover:text-blue-800">Kidney Stones</a></li>
                            <li><a href="#hypertension-management" className="font-bold text-blue-500 no-underline hover:text-blue-800">Hypertension Management</a></li>
                            <li><a href="#post-transplant-care" className="font-bold text-blue-500 no-underline hover:text-blue-800">Post-Transplant Care</a></li>
                            <li><a href="#hyponatremia" className="font-bold text-blue-500 no-underline hover:text-blue-800">Hyponatremia</a></li>
                            <li><a href="#hematuria" className="font-bold text-blue-500 no-underline hover:text-blue-800">Hematuria</a></li>
                            <li><a href="#proteinuria" className="font-bold text-blue-500 no-underline hover:text-blue-800">Proteinuria</a></li>
                            <li><a href="#hyperkalemia" className="font-bold text-blue-500 no-underline hover:text-blue-800">Hyperkalemia</a></li>
                            <li><a href="#electrolyte-disorders" className="font-bold text-blue-500 no-underline hover:text-blue-800">Electrolyte Disorders</a></li>
                            <li><a href="#anemia" className="font-bold text-blue-500 no-underline hover:text-blue-800">Anemia</a></li>
                            <li><a href="#dialysis" className="font-bold text-blue-500 no-underline hover:text-blue-800">Dialysis</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="list-disc pl-5">
                            <li><a href="#how-kidneys-work" className="font-bold text-blue-500 no-underline hover:text-blue-800">How do Kidneys Work?</a></li>
                            <li><a href="#understanding-labs" className="font-bold text-blue-500 no-underline hover:text-blue-800">Understanding Labs</a></li>
                            <li><a href="#egfr-test" className="font-bold text-blue-500 no-underline hover:text-blue-800">EGFR/Kidney Function Test</a></li>
                            <li><a href="#renal-ultrasound" className="font-bold text-blue-500 no-underline hover:text-blue-800">Renal Ultrasound</a></li>
                            <li><a href="#kidney-biopsy" className="font-bold text-blue-500 no-underline hover:text-blue-800">Kidney Biopsy</a></li>
                            <li><a href="#dialysis-access" className="font-bold text-blue-500 no-underline hover:text-blue-800">Dialysis Access</a></li>
                        </ul>
                    </div>
